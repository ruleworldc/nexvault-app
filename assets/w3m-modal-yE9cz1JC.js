import{A as e,C as t,E as n,S as r,T as i,_ as a,j as o,l as s,r as c,s as l,t as u,v as ee,y as d}from"./ModalController-CrVFV_RF.js";import{_ as f,c as p,d as m,f as te,l as h,m as g,o as _,p as ne,s as v,v as y,w as re,x as b,y as x}from"./wui-text-U3-alNhv.js";import{t as ie}from"./SwapController-jYTIql3D.js";import"./wui-icon-box-CFoJ2zrz.js";import{t as S}from"./ConstantsUtil-Dnxv1B60.js";import{D as C,O as w,x as T}from"./index-CKGjWdV0.js";import{n as E}from"./exports-4TiOSa-W.js";var D={isUnsupportedChainView(){return d.state.view===`UnsupportedChain`||d.state.view===`SwitchNetwork`&&d.state.history.includes(`UnsupportedChain`)},async safeClose(){if(this.isUnsupportedChainView()){u.shake();return}if(await w.isSIWXCloseDisabled()){u.shake();return}(d.state.view===`DataCapture`||d.state.view===`DataCaptureOtpConfirm`)&&s.disconnect(),u.close()}},ae=f`
  :host {
    display: block;
