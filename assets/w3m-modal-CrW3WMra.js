import{A as e,C as t,E as n,S as r,T as i,_ as a,j as o,l as s,r as c,s as l,t as u,v as ee,y as d}from"./ModalController-CrVFV_RF.js";import{_ as f,c as p,d as m,f as te,l as h,m as g,o as _,p as ne,s as v,v as y,w as re,x as b,y as x}from"./wui-text-U3-alNhv.js";import{t as ie}from"./SwapController-DKzFQqwA.js";import"./wui-icon-box-CFoJ2zrz.js";import{t as S}from"./ConstantsUtil-Dnxv1B60.js";import{D as C,O as w,x as T}from"./index-DrGQEb38.js";import{n as E}from"./exports-Btv0dPYY.js";var D={isUnsupportedChainView(){return d.state.view===`UnsupportedChain`||d.state.view===`SwitchNetwork`&&d.state.history.includes(`UnsupportedChain`)},async safeClose(){if(this.isUnsupportedChainView()){u.shake();return}if(await w.isSIWXCloseDisabled()){u.shake();return}(d.state.view===`DataCapture`||d.state.view===`DataCaptureOtpConfirm`)&&s.disconnect(),u.close()}},ae=f`
  :host {
    display: block;
...
`,k=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},ce={info:`info`,success:`checkmark`,warning:`warningCircle`,error:`warning`},A=class extends x{constructor(){super(...arguments),this.message=``,this.type=`info`}render(){return b`
    ...
    `}onClose(){C.close()}};A.styles=[g,se],k([p()],A.prototype,`message`,void 0),k([p()],A.prototype,`type`,void 0),A=k([h(`wui-alertbar`)],A);var le=f`
  :host {
    display: block;
    position: absolute;
    top: ${({spacing:e})=>e[3]};
