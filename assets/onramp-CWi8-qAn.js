import{A as e,B as t,C as n,E as r,T as i,g as a,j as o,l as s,r as c,t as l,v as u,y as d,z as f}from"./ModalController-CrVFV_RF.js";import{_ as p,c as m,l as h,o as g,s as _,x as v,y}from"./wui-text-U3-alNhv.js";import{E as b,L as x}from"./index-DrGQEb38.js";import"./wui-image-DWN9k3d4.js";var S=p`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`,C=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},w=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=x.state.paymentCurrency,this.currencies=x.state.paymentCurrencies,this.currencyImages=r.state.currencyImages,this.checked=b.state.isLegalCheckboxChecked,this.unsubscribe.push(x.subscribe(e=>{this.selectedCurrency=e.paymentCurrency,this.currencies=e.paymentCurrencies}),r.subscribeKey(`currencyImages`,e=>this.currencyImages=e),b.subscribeKey(`isLegalCheckboxChecked`,e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:t}=o.state,n=o.state.features?.legalCheckbox,r=!!(e||t)&&!!n&&!this.checked;return v`
    ...
    `}currenciesTemplate(e=!1){return this.currencies.map(t=>v`
      ...
      `)}selectCurrency(e){e&&(x.setPaymentCurrency(e),l.close())}};w.styles=S,C([_()],w.prototype,`selectedCurrency`,void 0),C([_()],w.prototype,`currencies`,void 0),C([_()],w.prototype,`currencyImages`,void 0),C([_()],w.prototype,`checked`,void 0),w=C([h(`w3m-onramp-fiat-select-view`)],w);var T=p`
  button {
...
`,j=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},M=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=x.state.purchaseCurrencies,this.tokens=x.state.purchaseCurrencies,this.tokenImages=r.state.tokenImages,this.checked=b.state.isLegalCheckboxChecked,this.unsubscribe.push(x.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),r.subscribeKey(`tokenImages`,e=>this.tokenImages=e),b.subscribeKey(`isLegalCheckboxChecked`,e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:t}=o.state,n=o.state.features?.legalCheckbox,r=!!(e||t)&&!!n&&!this.checked;return v`
      <w3m-legal-checkbox></w3m-legal-checkbox>
      <wui-flex
        flexDirection="column"
        .padding=${[`0`,`3`,`3`,`3`]}
    ...
    `}currenciesTemplate(e=!1){return this.tokens.map(t=>v`
      ...
      `)}selectToken(e){e&&(x.setPurchaseCurrency(e),l.close())}};M.styles=A,j([_()],M.prototype,`selectedCurrency`,void 0),j([_()],M.prototype,`tokens`,void 0),j([_()],M.prototype,`tokenImages`,void 0),j([_()],M.prototype,`checked`,void 0),M=j([h(`w3m-onramp-token-select-view`)],M);var N=p`
  @keyframes shake {
    0% {
...
`,P=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},F=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=x.state.selectedProvider,this.uri=s.state.wcUri,this.ready=!1,this.showRetry=!1,this.buffering=!1,this.error=!1,this.isMobile=!1,this.onRetry=void 0,this.unsubscribe.push(x.subscribeKey(`selectedProvider`,e=>{this.selectedOnRampProvider=e}))}disconnectedCallback(){this.intervalId&&clearInterval(this.intervalId)}render(){let e=`Continue in external window`;this.error?e=`Buy failed`:this.selectedOnRampProvider&&(e=`Buy in ${this.selectedOnRampProvider?.label}`);let t=this.error?`Buy can be declined from your side or due to and error on the provider app`:`We’ll notify you once your Buy is processed`;return v`
      <wui-flex
...
`,z=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},B=class extends y{constructor(){super(),this.unsubscribe=[],this.type=`Token`,this.value=0,this.currencies=[],this.selectedCurrency=this.currencies?.[0],this.currencyImages=r.state.currencyImages,this.tokenImages=r.state.tokenImages,this.unsubscribe.push(x.subscribeKey(`purchaseCurrency`,e=>{!e||this.type===`Fiat`||(this.selectedCurrency=this.formatPurchaseCurrency(e))}),x.subscribeKey(`paymentCurrency`,e=>{!e||this.type===`Token`||(this.selectedCurrency=this.formatPaymentCurrency(e))}),x.subscribe(e=>{this.type===`Fiat`?this.currencies=e.purchaseCurrencies.map(this.formatPurchaseCurrency):this.currencies=e.paymentCurrencies.map(this.formatPaymentCurrency)}),r.subscribe(e=>{this.currencyImages={...e.currencyImages},this.tokenImages={...e.tokenImages}}))}firstUpdated(){x.getAvailableCurrencies()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.selectedCurrency?.symbol||``,t=this.currencyImages[e]||this.tokenImages[e];return v`<wui-input-text type="number" size="lg" value=${this.value}>
...
`,H=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},U={USD:`$`,EUR:`€`,GBP:`£`},W=[100,250,500,1e3],G=class extends y{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=c.state.activeCaipAddress,this.loading=l.state.loading,this.paymentCurrency=x.state.paymentCurrency,this.paymentAmount=x.state.paymentAmount,this.purchaseAmount=x.state.purchaseAmount,this.quoteLoading=x.state.quotesLoading,this.unsubscribe.push(c.subscribeKey(`activeCaipAddress`,e=>this.caipAddress=e),l.subscribeKey(`loading`,e=>{this.loading=e}),x.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return v`
    ...
    `}templateButton(){return this.caipAddress?v`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||l.open({view:`OnRampProviders`})}openModal(){l.open({view:`Connect`})}async onPaymentAmountChange(e){x.setPaymentAmount(Number(e.detail)),await x.getQuote()}async selectPresetAmount(e){x.setPaymentAmount(e),await x.getQuote()}};G.styles=V,H([m({type:Boolean})],G.prototype,`disabled`,void 0),H([_()],G.prototype,`caipAddress`,void 0),H([_()],G.prototype,`loading`,void 0),H([_()],G.prototype,`paymentCurrency`,void 0),H([_()],G.prototype,`paymentAmount`,void 0),H([_()],G.prototype,`purchaseAmount`,void 0),H([_()],G.prototype,`quoteLoading`,void 0),G=H([h(`w3m-onramp-widget`)],G);export{F as W3mBuyInProgressView,k as W3mOnRampProvidersView,w as W3mOnrampFiatSelectView,M as W3mOnrampTokensView,G as W3mOnrampWidget,L as W3mWhatIsABuyView};